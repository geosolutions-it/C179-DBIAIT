...
BEGIN 
   SET search_path = public,dbiait_analysis; 
   SELECT count(0) INTO v_count FROM ( 
   SELECT "acq_adduttrice"."codice_ato" "codice_ato","acq_adduttrice"."denom" "denom","acq_adduttrice"."portata_media" "portata_media","acq_adduttrice"."d_stato" "d_stato","acq_adduttrice"."a_portata_media" "a_portata_media","acq_adduttrice"."data_agg" "data_agg","acq_adduttrice"."nr_rip" "nr_rip",TO_BIT("acq_auth_adduttr"."sn_strum_mis_port") "sn_strum_mis_port","acq_auth_adduttr"."d_tipo_cloraz" "d_tipo_cloraz","acq_auth_adduttr"."anno_instal_clor" "anno_instal_clor","acq_auth_adduttr"."anno_ristr_clor" "anno_ristr_clor","acq_lunghezza_rete"."lunghezza" "lunghezza","acq_lunghezza_rete"."lunghezza_tlc" "lunghezza_tlc","stats_cloratore"."counter" "count_cloratori" FROM "acq_adduttrice" "acq_adduttrice" LEFT JOIN "acq_auth_adduttr" "acq_auth_adduttr" ON "acq_adduttrice"."idgis"="acq_auth_adduttr"."id_adduttrice" LEFT JOIN "acq_lunghezza_rete" "acq_lunghezza_rete" ON "acq_adduttrice"."codice_ato"="acq_lunghezza_rete"."codice_ato" LEFT JOIN "stats_cloratore" "stats_cloratore" ON "acq_adduttrice"."idgis"="stats_cloratore"."id_rete" WHERE acq_adduttrice.d_gestore = 'PUBLIACQUA' AND acq_adduttrice.d_ambito IN ('AT3', NULL) AND acq_adduttrice.d_stato NOT IN ('IPR','IAC') UNION ALL SELECT "a_acq_adduttrice"."codice_ato" "codice_ato","a_acq_adduttrice"."denom" "denom","a_acq_adduttrice"."portata_media" "portata_media","a_acq_adduttrice"."d_stato" "d_stato","a_acq_adduttrice"."a_portata_media" "a_portata_media","a_acq_adduttrice"."data_agg" "data_agg","a_acq_adduttrice"."nr_rip" "nr_rip",TO_BIT("acq_auth_adduttr"."sn_strum_mis_port") "sn_strum_mis_port","acq_auth_adduttr"."d_tipo_cloraz" "d_tipo_cloraz","acq_auth_adduttr"."anno_instal_clor" "anno_instal_clor","acq_auth_adduttr"."anno_ristr_clor" "anno_ristr_clor","acq_lunghezza_rete"."lunghezza" "lunghezza","acq_lunghezza_rete"."lunghezza_tlc" "lunghezza_tlc","stats_cloratore"."counter" "count_cloratori" FROM "a_acq_adduttrice" "a_acq_adduttrice" LEFT JOIN "acq_auth_adduttr" "acq_auth_adduttr" ON "a_acq_adduttrice"."idgis"="acq_auth_adduttr"."id_adduttrice" LEFT JOIN "acq_lunghezza_rete" "acq_lunghezza_rete" ON "a_acq_adduttrice"."codice_ato"="acq_lunghezza_rete"."codice_ato" LEFT JOIN "stats_cloratore" "stats_cloratore" ON "a_acq_adduttrice"."idgis"="stats_cloratore"."id_rete" WHERE a_acq_adduttrice.d_gestore = 'PUBLIACQUA' AND a_acq_adduttrice.d_ambito IN ('AT3', NULL) AND a_acq_adduttrice.d_stato NOT IN ('IPR','IAC')
   ) t; 
   SET search_path = public,pgunit; 
   PERFORM test_assertTrue('count XLS {0}, expected ' || v_expected || ' but found ' || v_count, v_count = v_expected); 
END; 
...
BEGIN 
   SET search_path = public,dbiait_analysis; 
   SELECT count(0) INTO v_count FROM ( 
   SELECT "codice_ato" "codice_ato","d_stato_cons" "d_stato_cons","anno_instal" "anno_instal","anno_ristr" "anno_ristr","potenza" "potenza","portata" "portata","prevalenza" "prevalenza",TO_BIT("sn_riserva") "sn_riserva","a_anno_instal" "a_anno_instal","a_anno_ristr" "a_anno_ristr","a_potenza" "a_potenza","a_portata" "a_portata","a_prevalenza" "a_prevalenza" FROM "archivio_pompe" "archivio_pompe" WHERE archivio_pompe.tipo_oggetto = 'FGN_TRATTAMENTO'
   ) t; 
   SET search_path = public,pgunit; 
   PERFORM test_assertTrue('count XLS {0}, expected ' || v_expected || ' but found ' || v_count, v_count = v_expected); 
END; 
...
BEGIN 
   SET search_path = public,dbiait_analysis; 
   SELECT count(0) INTO v_count FROM ( 
   SELECT "fognat_tronchi"."idgis" "idgis","fognat_tronchi"."idgis_rete" "idgis_rete","fognat_tronchi"."recapito" "recapito","fognat_tronchi"."id_materiale" "id_materiale","fognat_tronchi"."id_conservazione" "id_conservazione","fognat_tronchi"."diametro" "diametro","fognat_tronchi"."anno" "anno","fognat_tronchi"."funziona_gravita" "funziona_gravita","fognat_tronchi"."lunghezza" "lunghezza","fognat_tronchi"."idx_materiale" "idx_materiale","fognat_tronchi"."idx_diametro" "idx_diametro","fognat_tronchi"."idx_anno" "idx_anno","fognat_tronchi"."idx_lunghezza" "idx_lunghezza","fognat_tronchi"."depurazione" "depurazione","fognat_tronchi"."id_refluo_trasportato" "id_refluo_trasportato","acq_condotta"."data_esercizio" "data_esercizio","fgn_condotta"."codice_ato" "codice_ato" FROM "fognat_tronchi" "fognat_tronchi" LEFT JOIN "acq_condotta" "acq_condotta" ON "acq_condotta"."idgis"="fognat_tronchi"."idgis" LEFT JOIN "fgn_condotta" "fgn_condotta" ON "fgn_condotta"."idgis"="fognat_tronchi"."idgis"
   ) t; 
   SET search_path = public,pgunit; 
   PERFORM test_assertTrue('count XLS {0}, expected ' || v_expected || ' but found ' || v_count, v_count = v_expected); 
END; 
...
BEGIN 
   SET search_path = public,dbiait_analysis; 
   SELECT count(0) INTO v_count FROM ( 
   SELECT "acq_pompaggio"."codice_ato" "codice_ato","acq_pompaggio"."denom" "denom",FROM_FLOAT_TO_INT("acq_pompaggio"."quota") "quota","acq_pompaggio"."anno_costr" "anno_costr","acq_auth_pompag"."anno_ristr_civ" "anno_ristr_civ","acq_auth_pompag"."d_stato_cons_civ" "d_stato_cons_civ","acq_auth_pompag"."anno_ristr_elmec" "anno_ristr_elmec","acq_auth_pompag"."d_stato_cons_elmec" "d_stato_cons_elmec","acq_auth_pompag"."d_telecont" "d_telecont","acq_pompaggio"."cod_comune" "cod_comune",TO_BIT("acq_auth_pompag"."sn_strum_mis_pres") "sn_strum_mis_pres",TO_BIT("acq_auth_pompag"."sn_strum_mis_port") "sn_strum_mis_port","acq_pompaggio"."d_stato" "d_stato","acq_pompaggio"."a_anno_costr" "a_anno_costr","acq_auth_pompag"."a_anno_ristr_civ" "a_anno_ristr_civ","acq_auth_pompag"."a_anno_ristr_elmec" "a_anno_ristr_elmec","acq_pompaggio"."data_agg" "data_agg",GB_X("acq_pompaggio"."geom") "transformed_x_geom",GB_Y("acq_pompaggio"."geom") "transformed_y_geom","stats_pompe"."sum_potenza" "sum_potenza","stats_pompe"."avg_idx_potenza" "avg_idx_potenza","localita"."denominazi" "denominazi","acq_auth_pompag"."consumo_ee" "consumo_ee" FROM "acq_pompaggio" "acq_pompaggio" LEFT JOIN "acq_auth_pompag" "acq_auth_pompag" ON "acq_auth_pompag"."id_pompaggio"="acq_pompaggio"."idgis" LEFT JOIN "stats_pompe" "stats_pompe" ON "stats_pompe"."codice_ato"="acq_pompaggio"."codice_ato" LEFT JOIN "localita" "localita" ON ST_INTERSECTS("localita"."geom","acq_pompaggio"."geom") WHERE acq_pompaggio.d_gestore = 'PUBLIACQUA' AND acq_pompaggio.d_ambito IN ('AT3', NULL) AND acq_pompaggio.d_stato NOT IN ('IPR', 'IAC') UNION ALL SELECT "a_acq_pompaggio"."codice_ato" "codice_ato","a_acq_pompaggio"."denom" "denom",FROM_FLOAT_TO_INT("a_acq_pompaggio"."quota") "quota","a_acq_pompaggio"."anno_costr" "anno_costr","acq_auth_pompag"."anno_ristr_civ" "anno_ristr_civ","acq_auth_pompag"."d_stato_cons_civ" "d_stato_cons_civ","acq_auth_pompag"."anno_ristr_elmec" "anno_ristr_elmec","acq_auth_pompag"."d_stato_cons_elmec" "d_stato_cons_elmec","acq_auth_pompag"."d_telecont" "d_telecont","a_acq_pompaggio"."cod_comune" "cod_comune",TO_BIT("acq_auth_pompag"."sn_strum_mis_pres") "sn_strum_mis_pres",TO_BIT("acq_auth_pompag"."sn_strum_mis_port") "sn_strum_mis_port","a_acq_pompaggio"."d_stato" "d_stato","a_acq_pompaggio"."a_anno_costr" "a_anno_costr","acq_auth_pompag"."a_anno_ristr_civ" "a_anno_ristr_civ","acq_auth_pompag"."a_anno_ristr_elmec" "a_anno_ristr_elmec","a_acq_pompaggio"."data_agg" "data_agg",GB_X("a_acq_pompaggio"."geom") "transformed_x_geom",GB_Y("a_acq_pompaggio"."geom") "transformed_y_geom","stats_pompe"."sum_potenza" "sum_potenza","stats_pompe"."avg_idx_potenza" "avg_idx_potenza","localita"."denominazi" "denominazi","acq_auth_pompag"."consumo_ee" "consumo_ee" FROM "a_acq_pompaggio" "a_acq_pompaggio" LEFT JOIN "acq_auth_pompag" "acq_auth_pompag" ON "acq_auth_pompag"."id_pompaggio"="a_acq_pompaggio"."idgis" LEFT JOIN "stats_pompe" "stats_pompe" ON "stats_pompe"."codice_ato"="a_acq_pompaggio"."codice_ato" LEFT JOIN "localita" "localita" ON ST_INTERSECTS("localita"."geom","a_acq_pompaggio"."geom") WHERE a_acq_pompaggio.d_gestore = 'PUBLIACQUA' AND a_acq_pompaggio.d_ambito IN ('AT3', NULL) AND a_acq_pompaggio.d_stato NOT IN ('IPR', 'IAC')
   ) t; 
   SET search_path = public,pgunit; 
   PERFORM test_assertTrue('count XLS {0}, expected ' || v_expected || ' but found ' || v_count, v_count = v_expected); 
END; 
...
BEGIN 
   SET search_path = public,dbiait_analysis; 
   SELECT count(0) INTO v_count FROM ( 
   SELECT "codice_ato" "codice_ato","d_stato_cons" "d_stato_cons","anno_instal" "anno_instal","anno_ristr" "anno_ristr","potenza" "potenza","portata" "portata","prevalenza" "prevalenza",TO_BIT("sn_riserva") "sn_riserva","a_anno_instal" "a_anno_instal","a_anno_ristr" "a_anno_ristr","a_potenza" "a_potenza","a_portata" "a_portata","a_prevalenza" "a_prevalenza" FROM "archivio_pompe" "archivio_pompe" WHERE archivio_pompe.tipo_oggetto = 'ACQ_POMPAGGIO'
   ) t; 
   SET search_path = public,pgunit; 
   PERFORM test_assertTrue('count XLS {0}, expected ' || v_expected || ' but found ' || v_count, v_count = v_expected); 
END; 
...
BEGIN 
   SET search_path = public,dbiait_analysis; 
   SELECT count(0) INTO v_count FROM ( 
   SELECT "codice_ato" "codice_ato","d_stato_cons" "d_stato_cons","anno_instal" "anno_instal","anno_ristr" "anno_ristr","potenza" "potenza","portata" "portata","prevalenza" "prevalenza",TO_BIT("sn_riserva") "sn_riserva","a_anno_instal" "a_anno_instal","a_anno_ristr" "a_anno_ristr","a_potenza" "a_potenza","a_portata" "a_portata","a_prevalenza" "a_prevalenza" FROM "archivio_pompe" "archivio_pompe" WHERE archivio_pompe.tipo_oggetto = 'ACQ_POTABILIZ'
   ) t; 
   SET search_path = public,pgunit; 
   PERFORM test_assertTrue('count XLS {0}, expected ' || v_expected || ' but found ' || v_count, v_count = v_expected); 
END; 
...
BEGIN 
   SET search_path = public,dbiait_analysis; 
   SELECT count(0) INTO v_count FROM ( 
   SELECT "codice_ato" "codice_ato","d_stato_cons" "d_stato_cons","anno_instal" "anno_instal","anno_ristr" "anno_ristr","potenza" "potenza","portata" "portata","prevalenza" "prevalenza",TO_BIT("sn_riserva") "sn_riserva","a_anno_instal" "a_anno_instal","a_anno_ristr" "a_anno_ristr","a_potenza" "a_potenza","a_portata" "a_portata","a_prevalenza" "a_prevalenza" FROM "archivio_pompe" "archivio_pompe" WHERE archivio_pompe.tipo_oggetto = 'ACQ_CAPTAZIONE'
   ) t; 
   SET search_path = public,pgunit; 
   PERFORM test_assertTrue('count XLS {0}, expected ' || v_expected || ' but found ' || v_count, v_count = v_expected); 
END; 
...
BEGIN 
   SET search_path = public,dbiait_analysis; 
   SELECT count(0) INTO v_count FROM ( 
   SELECT "codice_ato" "codice_ato","d_stato_cons" "d_stato_cons","anno_instal" "anno_instal","anno_ristr" "anno_ristr","potenza" "potenza","portata" "portata","prevalenza" "prevalenza",TO_BIT("sn_riserva") "sn_riserva","a_anno_instal" "a_anno_instal","a_anno_ristr" "a_anno_ristr","a_potenza" "a_potenza","a_portata" "a_portata","a_prevalenza" "a_prevalenza" FROM "archivio_pompe" "archivio_pompe" WHERE archivio_pompe.tipo_oggetto = 'FGN_IMP_SOLLEV'
   ) t; 
   SET search_path = public,pgunit; 
   PERFORM test_assertTrue('count XLS {0}, expected ' || v_expected || ' but found ' || v_count, v_count = v_expected); 
END; 
